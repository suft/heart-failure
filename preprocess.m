...
fprintf('Creatinine Outlier Indexes -> %s\n', mat2str(creatinine_out));
...
fprintf('Ejection Outlier Indexes -> %s\n', mat2str(ejection_out));
...
fprintf('Platelets Outlier Indexes -> %s\n', mat2str(platelets_out));
...
fprintf('Serum Outlier Indexes -> %s\n', mat2str(serum_out));
...
fprintf('Serum Sodium Outlier Indexes -> %s\n', mat2str(serumSod_out));
...
fprintf('Time Outlier Indexes -> %s\n', mat2str(time_out));
